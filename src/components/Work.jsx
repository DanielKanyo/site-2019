                                    ...
                                    <CardActions className='work-project-learnmore'>
                                        <a href='https://trecapp.com' target='_blank' rel='noopener noreferrer'>
                                            <Button
                                                size='small'
                                                color='primary'
                                                className='work-project-learnmore-button trecapp-button'
                                            >
                                                Learn More
                                            </Button>
                                        </a>
                                    ...
                                    <CardActions className='work-project-learnmore'>
                                        <a href='https://kuechenmonitor.de/pages/index.html' target='_blank' rel='noopener noreferrer'>
                                            <Button
                                                size='small'
                                                color='primary'
                                                className='work-project-learnmore-button kuechenmonitor-button'
                                            >
                                                Learn More
                                            </Button>
                                        </a>
                                    ...
                                    <CardActions className='work-project-learnmore'>
                                        <a href='https://fruitica.rs/' target='_blank' rel='noopener noreferrer'>
                                            <Button
                                                size='small'
                                                color='primary'
                                                className='work-project-learnmore-button fruitica-button'
                                            >
                                                Learn More
                                            </Button>
                                        </a>
                                    ...
                                    <CardActions className='work-project-learnmore'>
                                        <a href='https://bodyspacestudio.rs/' target='_blank' rel='noopener noreferrer'>
                                            <Button
                                                size='small'
                                                color='primary'
                                                className='work-project-learnmore-button body-space-studio-button'
                                            >
                                                Learn More
                                            </Button>
                                        </a>
